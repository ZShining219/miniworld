...
export const fitnessApi = {
  ...
  createExercise: (data: { planId: string, name: string, defaultWeight: number, defaultReps: number }) => request<FitnessExercise>('/exercises', 'POST', data),
  updateExercise: (id: string, data: { name?: string, defaultWeight?: number, defaultReps?: number, sortOrder?: number }) => request<FitnessExercise>(`/exercises/${id}`, 'PUT', data),
